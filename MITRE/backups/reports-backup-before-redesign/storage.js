export const REPORTS_DB = 'mitre-reports-db';
export const REPORTS_STORE = 'reports';

export function initReportsDB() {
...
export function getReportsForLayer(layerId) {
    return new Promise(async (resolve, reject) => {
        try {
            const db = await initReportsDB();
...
export function deleteAllReports(layerId) {
    return new Promise(async (resolve, reject) => {
        try {
            const db = await initReportsDB();
            const tx = db.transaction(REPORTS_STORE, 'readwrite');
...
export function logActivity(type, techniqueId, details = '') {
...
export function detectChanges(lastReport) {
...
window.REPORTS_DB = REPORTS_DB;
window.REPORTS_STORE = REPORTS_STORE;
window.initReportsDB = initReportsDB;
window.saveReport = saveReport;
window.getReportsForLayer = getReportsForLayer;
window.deleteReport = deleteReport;
window.deleteAllReports = deleteAllReports;
window.logActivity = logActivity;
window.getActivitiesSince = getActivitiesSince;
