document.addEventListener('DOMContentLoaded', () => {
    ...
    if (terminalInput && terminalOutput) {
        ...
        const commands = {
            ...
            contact: 'Email: kieran.wadforth@pm.me | GitHub: @wadforth',
